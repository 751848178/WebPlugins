(function ($) {
	...
	Object.defineProperty(Object.prototype, "serializeSearch", {
		enumerable: false,
		value: function (obj, decollator) {
			var param = this,
				key = null,
				dec = "&";
			if (typeof(obj) == "object" && obj instanceof Object && typeof(obj.key) == "string") {
				key = obj.key;
				dec = obj.decollator ? obj.decollator : "&";
			}else if(typeof(obj) == "string" && obj){
				key = obj;
				dec = decollator ? decollator : "&";
			}
			decollator = dec;
			var paramStr = "";
			if (param instanceof String || param instanceof Number || param instanceof Boolean) {
				paramStr += decollator + key + "=" + encodeURIComponent(param);
			} else {
				$.each(param, function (i) {
					var k = key == null ? i : key + (param instanceof Array ? "[" + i + "]" : "." + i);
					paramStr += decollator + this.serializeSearch(k, decollator);
				});
			}
